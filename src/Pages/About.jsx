...
const About = () => {
  return (
    <div><center>
        ...
        <h1 id='h1'>The world’s destination<br></br>
for design</h1>
        <p>We’re on a mission to build the world’s best community for creatives to share, grow,
            <br></br> and get hired.</p>
...
<img src={img1} alt="about" id='img1' width={400} height={270} style={{ marginRight: '-25px'}} />
    ...
    <p>Since we are a 100% distributed team, you can work from anywhere. No need to <br></br>
